...
export default function FooterMenu() {
  ...
  return (
    <footer className="fixed bottom-0 z-[101010] hidden w-full h-12 text-white text-2xl bg-thematicColor justify-evenly items-center select-none sm:flex xs:text-xl xs:h-10">
      {/* analysis option */}
      <div
